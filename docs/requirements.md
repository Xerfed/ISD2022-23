...
| **Steps** | 
**1. User opens web browser                                                                                                                                               2. Get data from Bristol Open Database                                                                                                                                 3. Shows the current number of people in the local museum and others.                                                                                                   4. Shows wether it is busy or not.                                                                                                                                     5. Be able to see wether a museum is busy or not print a text "Not Busy", "Moderately Busy", "Busy"**
|
